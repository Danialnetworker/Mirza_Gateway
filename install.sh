...
function self_update_script() {
    ...
    local URL="https://raw.githubusercontent.com/Danialnetworker/Mirza_Gateway/main/install.sh"
...
function migrate_to_pro() {
    ...
    rm -rf "$OLD_BOT_DIR"
    mkdir -p "$NEW_BOT_DIR"
    ZIP_URL="https://github.com/Danialnetworker/Mirza_Gateway/archive/refs/heads/main.zip"
